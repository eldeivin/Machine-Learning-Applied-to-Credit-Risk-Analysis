...
The file `Machine_Learning_Applied_to_Credit_Risk_Analysis.pdf` contains the full research report.

**License:**  
This document is © [David Felipe Vargas Cadena], 2025.  
It is licensed under a [CC BY-NC-ND 4.0](https://creativecommons.org/licenses/by-nc-nd/4.0/) license.  
You may share this document with attribution, but you may not use it commercially or create derivative works.